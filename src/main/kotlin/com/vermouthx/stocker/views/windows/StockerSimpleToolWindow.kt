...
class StockerSimpleToolWindow : SimpleToolWindowPanel(true) {
    ...
    init {
        ...
        val leftActions = listOfNotNull(
            ...
            StockerRestartAction::class.qualifiedName?.let { actionManager.getAction(it) },
        ...
        val rightActionToolbar = actionManager.createActionToolbar(ActionPlaces.TOOLBAR, rightActionGroup, true)
